...
#define M2_SPD_Pin GPIO_PIN_2
#define M2_SPD_GPIO_Port GPIOA
#define M1_SPD_Pin GPIO_PIN_3
#define M1_SPD_GPIO_Port GPIOA
#define RCV_4_Pin GPIO_PIN_4
#define RCV_4_GPIO_Port GPIOA
#define RCV_3_Pin GPIO_PIN_5
#define RCV_3_GPIO_Port GPIOA
...
#define RCV_2_Pin GPIO_PIN_0
#define RCV_2_GPIO_Port GPIOB
#define RCV_1_Pin GPIO_PIN_1
#define RCV_1_GPIO_Port GPIOB
...
#define M1_BCK_Pin GPIO_PIN_14
#define M1_BCK_GPIO_Port GPIOB
#define M2_BCK_Pin GPIO_PIN_15
#define M2_BCK_GPIO_Port GPIOB
